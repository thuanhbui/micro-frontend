...
import { currency } from "home/books";
        ...
        <i className="ri-shopping-cart-2-fill text-2xl" id="showcart"></i>
          {items.length}
            ...
            {showCart && (
                <>
                    <div
                        className="z-40 absolute p-5 border-4 border-blue-800 bg-white rounded-xl text-black"
                        style={{
                            width: 500,
                            top: '100%',
                            right: 0,  
                        ...
                        >
                            {items.map((item) => (
                                <React.Fragment key={item.id}>
                                    ...
                                    <img src={item.image} alt={item.name} className="max-h-10 object-cover" />
                                    <div>{item.name}</div>
